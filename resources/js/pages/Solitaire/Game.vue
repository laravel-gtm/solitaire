...
<template>
    ...
    <div class="min-h-dvh bg-[#0a1a0a] font-mono">
        <!-- Background grid pattern -->
        <div class="absolute inset-0 bg-[linear-gradient(to_right,#16531620_1px,transparent_1px),linear-gradient(to_bottom,#16531620_1px,transparent_1px)] bg-[size:40px_40px]" />
        ...
        <div class="relative mx-auto max-w-4xl px-4 py-6">
            ...
            <div class="card-size relative rounded-xl border border-[#dc2626]/40 bg-[#071207] p-3 shadow-[0_0_40px_rgba(220,38,38,0.2)] sm:p-6">
                <!-- Corner accents -->
                <div class="absolute -left-1 -top-1 h-6 w-6 border-l-2 border-t-2 border-[#d97706]" />
                <div class="absolute -right-1 -top-1 h-6 w-6 border-r-2 border-t-2 border-[#d97706]" />
                <div class="absolute -bottom-1 -left-1 h-6 w-6 border-b-2 border-l-2 border-[#d97706]" />
                <div class="absolute -bottom-1 -right-1 h-6 w-6 border-b-2 border-r-2 border-[#d97706]" />
                <GameBoard
